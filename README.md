...
| Bonbon | A JRPG game set in a sweets-themed world (VGDev - fall 2023). | Kingdom wall 3D model, attack impact VFX, crystal shader, inventory system sorting method, life steal action | ![Cake kingdom wall 3D model](CakeKingdomWall.png) ![Impact VFX gif](ImpactVFXTest.gif) | link |
| Epitaph | A 2D roguelike game following a struggling exorcist (VGDev - fall 2023). | NPC dialogue system | ![Impact VFX gif](ImpactVFXTest.gif) | link |
